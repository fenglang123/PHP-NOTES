...
|     |  Lumen   | Hyperf  |
|  ----  | ----  | ----  |
| 第一次  | 吞吐率：888；用户平均等待时间：112； | 吞吐率：4430；用户平均等待时间：22； |
| 第二次  | 吞吐率：906；用户平均等待时间：110； | 吞吐率：4380；用户平均等待时间：22； |
#### 一次数据库查询
|     |  Lumen   | Hyperf  |
|  ----  | ----  | ----  |
| 第一次  | 吞吐率：326；用户平均等待时间：305； | 吞吐率：1393；用户平均等待时间：71； |
| 第二次  | 吞吐率：328；用户平均等待时间：304； | 吞吐率：1366；用户平均等待时间：73； |
